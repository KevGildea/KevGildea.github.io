...
This approach allows for the generation of all possible solutions for kinematic chain mapping, and may allow for the development of a loss function for optimization according to kinematic constraints of a system (e.g. joint ranges of motion). 
