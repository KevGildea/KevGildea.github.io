...
Step 1: Transform chains a and b such that the current joint a<sub>k</sub>, and b<sub>k</sub> are at the origin. i.e. first apply this to the root joints a<sub>0</sub>, and b<sub>0</sub>.
